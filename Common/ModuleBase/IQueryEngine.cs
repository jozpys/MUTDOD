...
namespace MUTDOD.Common.ModuleBase
{
    ...
    {
        IQueryResult Execute(string dbName, IQuery query, SystemInfo systemInfo, Action<IQueryElement> doOnDataServers);
        IQueryPlanReslult GetQueryPlan(string dbName, IQuery query);
    }
}
