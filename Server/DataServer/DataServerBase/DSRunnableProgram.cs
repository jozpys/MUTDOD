...
{
    public class DSRunnableProgram
    {
        ...
        {
            public const string MutdodDataServerWindowTitleFormat = "MUTDOD Data Server: {0}";
            public const string MutdodDataServer = "MUTDOD Data Server";
        }
    }
}
