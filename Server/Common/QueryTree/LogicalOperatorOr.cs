...
{
    public class LogicalOperatorOr : AbstractComposite
    {
        public LogicalOperatorOr() : base(ElementType.WHERE_OPERATION) { }
        ...
        public override QueryDTO Execute(QueryParameters parameters)
        {
            ...
            QueryDTO query = new QueryDTO()
            {
                ...
                QueryObjects = leftResult.QueryObjects.Union(rightResult.QueryObjects)
            };
