...
namespace OdraIDE.ServerUtilities
{
    ...
    public abstract class AsyncOperation
    {
        ...
        public AsyncOperation(DispatcherObject target)
        {
            isiTarget = target;
            isRunning = false;
        }
        ...
        /// </summary>
        protected DispatcherObject Target
        {
            get { return isiTarget; }
        }
        private DispatcherObject isiTarget;
        ...
        protected void FireAsync(Delegate dlg, params object[] pList)
        {
            if (dlg != null)
            {
                Target.Dispatcher.BeginInvoke(dlg, pList);
            }
        }
    }
}
