...
namespace OdraIDE.Editor.DODQL.Workbench.ToolBar
{
    ...
    public class EditorToolBar : AbstractToolBar, IPartImportsSatisfiedNotification
    {
        ...
        [ImportMany(Sbql.ExtensionPoints.Workbench.ToolBars.Editor, typeof(IToolBarItem), AllowRecomposition = true)]
    ...
    [Export(Sbql.ExtensionPoints.Workbench.ToolBars.Editor, typeof(IToolBarItem))]
    public class EditorToolbarCommentLines : AbstractToolBarButton, IPartImportsSatisfiedNotification
    {
        [Import(Sbql.CompositionPoints.Workbench.Commands.CommentLines, typeof(ICustomCommand))]
