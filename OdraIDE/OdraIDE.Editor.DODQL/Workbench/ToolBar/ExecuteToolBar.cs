...
namespace OdraIDE.Editor.DODQL.Workbench.ToolBar
{
    ...
    public class ExecuteToolBar : AbstractToolBar, IPartImportsSatisfiedNotification
    {
        ...
        [ImportMany(Sbql.ExtensionPoints.Workbench.ToolBars.Execute, typeof(IToolBarItem), AllowRecomposition = true)]
    ...
    [Export(Sbql.ExtensionPoints.Workbench.ToolBars.Execute, typeof(IToolBarItem))]
    public class ExecuteToolbarExecuteQuery : AbstractToolBarButton, IPartImportsSatisfiedNotification
    {
        [Import(Sbql.CompositionPoints.Workbench.Commands.ExecuteQuery, typeof(ICustomCommand))]
    ...
    {
        [Import(Sbql.CompositionPoints.Workbench.Commands.ExecuteSelectedQuery, typeof(ICustomCommand))]
        private ICustomCommand command { get; set; }
    ...
    {
        [Import(Sbql.CompositionPoints.Workbench.Commands.CancelExecuteQuery, typeof(ICustomCommand))]
        private ICustomCommand command { get; set; }
    ...
    [Export(Sbql.ExtensionPoints.Workbench.ToolBars.Execute, typeof(IToolBarItem))]
    [Export(Sbql.CompositionPoints.Workbench.ExecuteToolbar.DatabasesComboBox, typeof(DatabasesToolBarComboBox))]
